    ...
    public partial class d : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserDataActivityId = table.Column<int>(type: "INTEGER", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDataActivity", x => x.UserDataActivityId);
                    table.ForeignKey(
                        name: "FK_UserDataActivity_BlogUser_BlogUserId",
                        column: x => x.BlogUserId,
                        principalTable: "BlogUser",
                        principalColumn: "BlogUserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserDataActivity_UserActivityTypes_UserActivityTypeId",
