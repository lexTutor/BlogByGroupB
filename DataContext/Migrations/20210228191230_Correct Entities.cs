        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostCreatorId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Post_BlogUser_PostCreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserPostActivityId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserActivityTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    PostId1 = table.Column<string>(type: "TEXT", nullable: true),
                    PostId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserActivities", x => x.UserPostActivityId);
                    table.ForeignKey(
